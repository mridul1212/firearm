...
class Digital_Aram_licence extends StatefulWidget {
  const Digital_Aram_licence({super.key});

  @override
  State<Digital_Aram_licence> createState() => _Digital_Aram_licenceState();
}

class _Digital_Aram_licenceState extends State<Digital_Aram_licence> with SingleTickerProviderStateMixin {
          ...
          children: [
            ...
            ListView(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal:  MediaQuery.of(context).size.width*0.309333),
                  child: Container(
                ...
                SizedBox(height: MediaQuery.of(context).size.height*0.0775862),
                Padding(padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width*0.0933333),
                child: Container(
                    width: MediaQuery.of(context).size.width*0.813333,
                    height: MediaQuery.of(context).size.height*0.238916,
                ...
                Padding(padding: EdgeInsets.symmetric(horizontal:MediaQuery.of(context).size.width*0.24),
                  child: Container(
