...
class QrCodeReg extends StatefulWidget {
  const QrCodeReg({super.key});

  @override
  State<QrCodeReg> createState() => _QrCodeRegState();
}

class _QrCodeRegState extends State<QrCodeReg> {
          ...
          children: [
            ...
            ListView(
              children: [
                ...
                Padding(padding: EdgeInsets.symmetric(horizontal:  MediaQuery.of(context).size.width*0.192),
                  child: Container(
                      width: MediaQuery.of(context).size.width*0.616,
                      height: MediaQuery.of(context).size.height*0.284483,
                    ...
                    child: Center(
                      child: Container(
                          ...
                          height: MediaQuery.of(context).size.height*0.229064,
                        decoration: BoxDecoration(
            ...
            Container(
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    left:  MediaQuery.of(context).size.width*0.413333,
                    top: MediaQuery.of(context).size.height*0.186256,
                    child: Container(
                        width: MediaQuery.of(context).size.width*0.226667,
